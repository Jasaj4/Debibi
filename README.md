...
- Insight tab: read-only drill-downs.
  ...
  - **My financial situation** (assets/liabilities with section headers); tap an account to see **Account Transaction List**, then drill into an entry.
